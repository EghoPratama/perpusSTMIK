...
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="form-name">
				<form class="form-signin" action="<?php echo base_url()."index.php/Login/edit_nama" ?>" method="post">
					<legend>GANTI NAMA</legend>
					<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
					<input type="text" class="input-block-level" placeholder="Nama Baru" name="new_nama" id="new_nama" autofocus required>
					<input type="password" class="input-block-level" placeholder="Password" name="new_password" id="new_password" autofocus required>
