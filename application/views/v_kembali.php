...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url('assests/bootstrap/css/bootstrap-datetimepicker.css')?>"/>
		<script src="<?php echo base_url('assests/jquery/moment-with-locales.js')?>"></script>
		<script src="<?php echo base_url('assests/jquery/bootstrap-datetimepicker.js')?>"></script>
		...
		<div class="wrapper">
			...
			<div class="container">
				...
				<h1 class="page-header">
					<span class="glyphicon glyphicon-tasks"></span>Data Pengembalian
					<div class="pull-right">
						<!--<div class="pull-right"><a href="#" class="btn btn-md btn-primary" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus glyphicon glyphicon-plus"></span>TAMBAH</a>-->
						<button type="button" class="btn btn-warning" id="cetak"><span class="glyphicon glyphicon-print"></span>CETAK</button>
					</div>
				</h1>
		        ...
		        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <div class="modal-header">
		                ...
		                <h3 class="modal-title" id="myModalLabel">Tambah Data Pengembalian</h3>
		            </div>
		            <form class="form-horizontal">
		                <div class="modal-body">
		 
		                    <div class="form-group">
		                        <label class="control-label col-xs-3">ID_PENGEMBALIAN</label>
		                        <div class="col-xs-9">
		                            <input name="ID_PENGEMBALIAN" id="ID_PENGEMBALIAN" class="form-control" type="text" placeholder="ID_PENGEMBALIAN" style="width:335px;" required>
		                        </div>
		                    </div>
		 
		                    <div class="form-group">
		                        <label class="control-label col-xs-3">TANGGAL_KEMBALI</label>
		                        <div class="col-xs-9">
		                            <input name="TANGGAL_KEMBALI" id="TANGGAL_KEMBALI" class="form-control" type="date" placeholder="TANGGAL_KEMBALI" style="width:335px;" required>
		                        </div>
		                    </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >TANGGAL_PENGEMBALIAN</label>
		                        <div class="col-xs-9">
		                            <input name="TANGGAL_PENGEMBALIAN" id="TANGGAL_PENGEMBALIAN" class="form-control" type="date" placeholder="TANGGAL_PENGEMBALIAN" style="width:335px;" required>
		                        </div>
		                    </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >DENDA</label>
		                        <div class="col-xs-9">
		                            <input name="DENDA" id="DENDA" class="form-control" type="text" placeholder="DENDA" style="width:335px;" required>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <input name="STATUS" id="STATUS" class="form-control" type="text" placeholder="STATUS" style="width:335px;" required>
		                        </div>
		                    </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Anggota_NIM</label>
		                        <div class="col-xs-9">
		                            <input name="Anggota_NIM" id="Anggota_NIM" class="form-control" type="text" placeholder="Anggota_NIM" style="width:335px;" required>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <input name="Buku_ID_BUKU" id="Buku_ID_BUKU" class="form-control" type="text" placeholder="Buku_ID_BUKU" style="width:335px;" required>
		                        </div>
		                    </div>
		        ...
		        <div class="modal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		                <h3 class="modal-title" id="myModalLabel">Edit Data Pengembalian</h3>
		            </div>
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >ID_PENGEMBALIAN</label>
		                        <div class="col-xs-9">
		                            <input name="ID_PENGEMBALIAN_edit" id="ID_PENGEMBALIAN2" class="form-control" type="text" placeholder="ID_PENGEMBALIAN" style="width:405px;" readonly>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >TANGGAL_PENGEMBALIAN</label>
		                        <div class="col-xs-9">
		                            <input name="TANGGAL_PENGEMBALIAN_edit" id="TANGGAL_PENGEMBALIAN2" class="form-control" type="datetime-local" placeholder="TANGGAL_PENGEMBALIAN" style="width:405px;" required>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >DENDA</label>
		                        <div class="col-xs-9">
		                            <input name="DENDA_edit" id="DENDA2" class="form-control" type="text" placeholder="DENDA" style="width:405px;" readonly>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >STATUS</label>
		                        <div class="col-xs-9">
		                            <select class="form-control" name="STATUS_edit" id="STATUS2" placeholder="Pilih Status..." style="width:405px;"  tabindex="-1" required>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Anggota_NIM</label>
		                        <div class="col-xs-9">
		                            <input name="Anggota_NIM_edit" id="Anggota_NIM2" class="form-control" type="text" placeholder="Anggota_NIM" style="width:405px;" readonly>
		                        </div>
		                    </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Anggota_NAMA</label>
		                        <div class="col-xs-9">
		                            <input name="Anggota_NAMA2" id="Anggota_NAMA2" class="form-control" type="text" placeholder="Anggota_NAMA2" style="width:405px;" readonly>
		                        </div>
		                    </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >BUKU JUDUL</label>
		                        <div class="col-xs-9">
		                            <input name="Buku_JUDUL2" id="Buku_JUDUL2" class="form-control" type="text" placeholder="Buku_JUDUL2" style="width:405px;" readonly>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Buku_ID_BUKU</label>
		                        <div class="col-xs-9">
		                            <input name="Buku_ID_BUKU_edit" id="Buku_ID_BUKU2" class="form-control" type="text" placeholder="Buku_ID_BUKU" style="width:405px;" readonly>
		                        </div>
		                    </div>
		            ...
		            <div class="modal-dialog" role="document">
		                <div class="modal-content">
		                    <div class="modal-header">
		                        ...
		                        <h4 class="modal-title" id="myModalLabel">Hapus Data Pengembalian</h4>
		                    </div>
		                    <form class="form-horizontal">
		                    <div class="modal-body">
		                                           
		                            <input type="hidden" name="kode" id="textkode" value="">
		                            <div class="alert alert-warning"><p>Apakah Anda yakin menghapus data pengembalian ini?</p></div>
		        ...
		        <div class="modal fade" id="ModalCetak" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		            <div class="modal-dialog" role="document">
		                <div class="modal-content">
		                    <div class="modal-header">
		                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">X</span></button>
		                        <h4 class="modal-title" id="myModalLabel">Cetak Data Pengembalian</h4>
		                    </div>
		                    <form action="<?php echo base_url()?>index.php/Login/cetak_kembali" method="GET" class="form-horizontal" target="blank">
		                <div class="modal-body">
		                    <div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function(){
		tampil_data_pengembalian();
		$('.data').DataTable({
			
		});

		//fungsi tampil pengembalian
        function tampil_data_pengembalian(){
        	var no = 1;
            $.ajax({
                type  : 'ajax',
                url   : '<?php echo base_url()?>index.php/Login/data_pengembalian',
                async : false,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0; i<data.length; i++){
                        html += '<tr>'+
                                ...
                                '<td>'+data[i].TANGGAL_PENGEMBALIAN+'</td>'+
                                '<td>'+data[i].DENDA+'</td>'+
                                '<td>'+data[i].STATUS+'</td>'+
                                '<td>'+data[i].NAMA+'</td>'+
                                ...
                                '<td style="text-align:right;">'+
                                    '<a href="javascript:;" class="btn btn-success btn-md ion-edit item_edit" data="'+data[i].ID_PENGEMBALIAN+'"></a>'+' '+
                                    '<a href="javascript:;" class="btn btn-danger btn-md ion-ios7-trash item_hapus" data="'+data[i].ID_PENGEMBALIAN+'"></a>'+
                                '</td>'+
                                '</tr>';
                        no++;
                    }
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('index.php/Login/get_pengembalian')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(ID_PENGEMBALIAN,TANGGAL_KEMBALI,TANGGAL_PENGEMBALIAN,DENDA,STATUS,Anggota_NIM,Anggota_NAMA,Buku_JUDUL,Buku_ID_BUKU,Admin_ID){
                        $('#ModalaEdit').modal('show');
                        $('[name="ID_PENGEMBALIAN_edit"]').val(data.ID_PENGEMBALIAN);
                        $('[name="TANGGAL_KEMBALI_edit"]').val(data.TANGGAL_KEMBALI);
                        $('[name="TANGGAL_PENGEMBALIAN_edit"]').val(data.TANGGAL_PENGEMBALIAN);
                        $('[name="DENDA_edit"]').val(data.DENDA);
        ...
        $('#btn_simpan').on('click',function(){
            var ID_PENGEMBALIAN=$('#ID_PENGEMBALIAN').val();
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/Login/simpan_pengembalian')?>",
                dataType : "JSON",
                data : {ID_PENGEMBALIAN:ID_PENGEMBALIAN, TANGGAL_KEMBALI:TANGGAL_KEMBALI, TANGGAL_PENGEMBALIAN:TANGGAL_PENGEMBALIAN, DENDA:DENDA, STATUS:STATUS, Anggota_NIM:Anggota_NIM, Buku_ID_BUKU:Buku_ID_BUKU, Admin_ID:Admin_ID},
                success: function(data){
                    $('[name="ID_PEMINJAMAN"]').val("");
                    $('[name="TANGGAL_KEMBALI"]').val("");
                    $('[name="TANGGAL_PENGEMBALIAN"]').val("");
                    $('[name="DENDA"]').val("");
                    $('[name="STATUS"]').val("");
                    ...
                    document.location.href = '<?php echo base_url('index.php/Login/kembali')?>';
                    tampil_data_pengembalian();
                },
                error: function(data){
                    	alert("Maaf data pengembalian tidak bisa disimpan !!");
                    	document.location.href = '<?php echo base_url('index.php/Login/kembali')?>';
                    }
            });
            return false;
        ...
        $('#btn_update').on('click',function(){
            var ID_PENGEMBALIAN=$('#ID_PENGEMBALIAN2').val();
            var TANGGAL_KEMBALI=$('#TANGGAL_KEMBALI2').val();
            var TANGGAL_PENGEMBALIAN=$('#TANGGAL_PENGEMBALIAN2').val();
            var DENDA=$('#DENDA2').val();
            var STATUS=$('#STATUS2').val();
            var Anggota_NIM=$('#Anggota_NIM2').val();
            var Buku_ID_BUKU=$('#Buku_ID_BUKU2').val();
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/Login/update_pengembalian')?>",
                dataType : "JSON",
                data : {ID_PENGEMBALIAN:ID_PENGEMBALIAN, TANGGAL_KEMBALI:TANGGAL_KEMBALI, TANGGAL_PENGEMBALIAN:TANGGAL_PENGEMBALIAN, DENDA:DENDA, STATUS:STATUS, Anggota_NIM:Anggota_NIM, Buku_ID_BUKU:Buku_ID_BUKU},
                success: function(data){
                    $('[name="ID_PEMINJAMAN_edit"]').val("");
                    $('[name="TANGGAL_KEMBALI_edit"]').val("");
                    $('[name="TANGGAL_PENGEMBALIAN_edit"]').val("");
                    $('[name="DENDA_edit"]').val("");
                ...
                error: function(data){
                    	alert("Maaf data pengembalian tidak bisa diedit !!");
                    	document.location.href = '<?php echo base_url('index.php/Login/kembali')?>';
                    }
            });
            return false;
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('index.php/Login/hapus_pengembalian')?>",
            dataType : "JSON",
                    data : {kode: kode},
                    success: function(data){
                    	document.location.href = '<?php echo base_url('index.php/Login/kembali')?>';
                    ...
                    error: function(data){
                    	alert("Maaf data pengembalian tidak bisa dihapus !!");
                    	document.location.href = '<?php echo base_url('index.php/Login/kembali')?>';
                    }
                });
                return false;
...
<script>
	/*$(function() { 
	  $('#TANGGAL_KEMBALI2').datetimepicker({
	   locale:'id',
	   format:'YYYY-MM-DD'
	   });
	 //document.getElementById('TANGGAL_PENGEMBALIAN2').value =  
	  $('#TANGGAL_PENGEMBALIAN2').datetimepicker({
	   locale:'id',
	   format:'YYYY-MM-DD'
	   });
	   
	   $('#TANGGAL_KEMBALI2').on("dp.change", function(e) {
	    $('#TANGGAL_PENGEMBALIAN2').data("DateTimePicker").minDate(e.date);
	  });
	  
	   $('#TANGGAL_PENGEMBALIAN2').on("dp.change", function(e) {
	    $('#TANGGAL_KEMBALI2').data("DateTimePicker").maxDate(e.date);
	      CalcDiff()
	   });
	...
	function CalcDiff(){
	var a = $('#TANGGAL_KEMBALI2').data("DateTimePicker").date();
	var b = $('#TANGGAL_PENGEMBALIAN2').data("DateTimePicker").date();
	console.log(a);
	console.log(b);
	    var timeDiff=0
	     if (b) {
		...
		$('#DENDA2').val(Math.floor(timeDiff/(86400))*500);   
	}*/
</script>
<script type="text/javascript">
	$(document).ready(function() {
	    $('#TANGGAL_KEMBALI2, #TANGGAL_PENGEMBALIAN2').on('change textInput input', function () {
	        if ( ($("#TANGGAL_KEMBALI2").val() != "") && ($("#TANGGAL_PENGEMBALIAN2").val() != "")) {
	            var oneDay = 24*60*60*1000; // hours*minutes*seconds*milliseconds
	            var firstDate = new Date($("#TANGGAL_KEMBALI2").val());
	            var secondDate = new Date($("#TANGGAL_PENGEMBALIAN2").val());
	            var diffDays = Math.round(Math.round((secondDate.getTime() - firstDate.getTime()) / (oneDay)));
	            if(diffDays>0){
	            	$("#DENDA2").val(diffDays*500);	
	            }
	            else{
	            	$("#DENDA2").val(diffDays*0);	
	            }
	        }
	    });
	});
